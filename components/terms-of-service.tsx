          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 sm:p-8 lg:p-12 border border-white/10 shadow-2xl">
            <div className="prose prose-invert max-w-none">
              <div className="text-gray-300 space-y-6 text-sm sm:text-base leading-relaxed">
                ...
                <div>
                  <p className="mb-4">
                    FundedPro is a performance-based capital allocation firm founded by Destiny Isibor, operating globally from Rodney Bay, St. Lucia.
                  </p>
                  <p className="mb-4">
                    Our infrastructure is powered by advanced trading systems, and financial operations are managed through regulated channels.
                  </p>
                  <p className="mb-4">
                    These Terms govern your access to our evaluation challenges, simulated trading accounts, and capital funding services (collectively, the "Services").
                  </p>
                  <p className="font-semibold text-white">
                    By registering, funding, or trading with us, you irrevocably accept these Terms. There is no appeal. No exception. No ambiguity.
                  </p>
                </div>

                {/* Section 1 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">1. ACCESS & ELIGIBILITY</h2>
                  <p className="mb-4">You must be:</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>At least 18 years of age</li>
                    <li>Legally permitted to use our Services</li>
                    <li>Not a resident of USA, Bangladesh, Russia, Iran, North Korea, or any FATF-restricted jurisdiction</li>
                  </ul>
                  <p className="mt-4">
                    We do not operate for the unqualified. Your participation is a privilege — not a right.
                  </p>
                </div>

                {/* Section 2 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">2. EVALUATION MODELS</h2>
                  ...
                  <p className="mb-4">
                    Rules are defined in our FAQ/Rules section and are binding upon purchase. Add-ons or special offers override standard terms during their validity.
                  </p>
                  <p className="font-semibold text-white">
                ...
                {/* Section 3 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">3. TRADING RULES</h2>
                  <p className="mb-4">We reward discipline. We eliminate exploitation.</p>
                  <p className="font-semibold text-white mb-4">ABSOLUTE PROHIBITIONS:</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Exceeding daily (5%) or total (10%) loss limits</li>
                    <li>Cross-account hedging (on or off-platform)</li>
                    <li>Using bots, AI, scripts, or automated trading systems</li>
                    <li>Arbitrage of any kind — latency, statistical, triangular</li>
                    <li>Exploiting price delays, data feed errors, or system bugs ("Latency Trading")</li>
                    <li>Copy trading, mirror accounts, or group coordination</li>
                    <li>Third-party trading or delegation</li>
                    <li>Opening abnormal position sizes (relative to your history)</li>
                    ...
                    <li>Using different IP addresses for dashboard and trading platform</li>
                    <li>Mismatched email registration across platforms (e.g., dashboard vs Tradovate)</li>
                  </ul>
                  <p className="mt-4">
                    We monitor behavior, not just outcomes. Pattern detection is algorithmic and relentless.
                  </p>
                  <p className="font-semibold text-white">
                ...
                {/* Section 4 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">4. PROFIT & PAYOUTS</h2>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Profit splits: Up to 80%, scaled by performance</li>
                    <li>Payouts processed by authorized financial partners</li>
                    <li>Withdrawal fee: Up to 3.5% (charged by third-party processors like Rise)</li>
                ...
                {/* Section 5 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">5. FEES & REFUNDS</h2>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>Refund requestable only if no trading activity within 7 days</li>
                    <li>Add-ons and upgrades are permanently non-refundable</li>
                    <li>Inactive accounts (30+ days) are suspended</li>
                  </ul>
                  <p className="mt-4">
                    Your fee covers data, infrastructure, and access — not guarantees.
                  </p>
                </div>

                {/* Section 6 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">6. ACCOUNT TERMINATION</h2>
                  <p className="mb-4">We may terminate your account at any time, including for:</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                {/* Section 7 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">7. DISPUTES & CHARGEBACKS</h2>
                  <p className="mb-4">Contact support@fundedpro.com before escalating.</p>
                  <p className="mb-4">Initiating a chargeback without resolution:</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Triggers permanent ban</li>
                    <li>Requires formal withdrawal of dispute</li>
                    <li>Reactivation takes 45–60 business days after compliance</li>
                  </ul>
                  <p className="mt-4">
                ...
                {/* Section 8 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">8. KYC VERIFICATION</h2>
                  <p className="mb-4">Mandatory before first payout.</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Submit valid government ID (Passport or National ID)</li>
                    <li>Expired documents rejected</li>
                    <li>Processed via Veriff or Sumsub</li>
                    <li>We do not store your personal data</li>
                  </ul>
                  <p className="mt-4">
                    No KYC = No payout. Period.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-4">
                    Everything — platform, rules, systems, branding — is our exclusive property.
                  </p>
                ...
                <div>
                  ...
                  <p className="mt-4">
                    You assume full risk. We provide opportunity — not insurance.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    You submit to our jurisdiction. No exceptions.
                  </p>
                </div>

                {/* Section 13 */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">13. CONTACT</h2>
                  <div className="bg-white/10 rounded-lg p-4">
                    <p className="mb-2"><strong>Email:</strong> support@fundedpro.com</p>
                    <p><strong>Address:</strong> Commercial Center, Level 2, Rodney Bay, St. Lucia</p>
                  </div>
                </div>

                {/* Prohibited Jurisdictions */}
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">PROHIBITED JURISDICTIONS</h2>
                  <p className="mb-4">Our services are not available in:</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>USA, Bangladesh, Russia, Iran, North Korea, Syria, Sudan, Cuba, Venezuela, Afghanistan, Belarus, Myanmar, Lebanon, Libya, Somalia, Yemen, Zimbabwe</li>
                  </ul>
                  <p className="mt-4">
                ...
                {/* Final Note */}
                <div className="bg-brand-cyan/10 border border-brand-cyan/20 rounded-lg p-6 mt-8">
                  <p className="text-center text-white font-medium">
                    <strong>FundedPro is not a platform. It's a filter.</strong><br />
                    We exist to identify the disciplined, the skilled, and the relentless.<br />
                    If you follow the rules, we reward you — massively.<br />
                    If you test the boundaries, you are gone.<br />
